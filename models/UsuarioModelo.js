...
const UsuariosSchema = mongoose.Schema(
	{
		...
		tipoContratacion: {
			type: String,
			trim: true,
			enum: [ 'Por obra o proyecto', 'Por tiempo determinado (temporal)', 'Tiempo indeterminado', 'Honorarios' ]
		},
		tipoPersonal: {
			type: String,
			trim: true,
		...
		cliente: {
			type: mongoose.Schema.ObjectId, ref: 'Clientes',
			required: true
		},
		departamento: [ { type: mongoose.Schema.ObjectId, ref: 'Departamentos' } ],
		area: [ { type: mongoose.Schema.ObjectId, ref: 'Areas' } ],
		puesto: [ { type: mongoose.Schema.ObjectId, ref: 'Puestos' } ]
	},
	{ versionKey: false }
);
